...
export default function About() {
  return (
    <div className="container mx-auto py-16 px-4">
      <h1 className="text-5xl font-bold mb-12 text-center text-green-800">About Ansarudeen Indiana</h1>
      
      <section className="mb-20">
        <h2 className="text-3xl font-bold mb-6 text-green-700">Our History and Mission</h2>
      ...
      <section className="mb-20">
        <h2 className="text-3xl font-bold mb-6 text-green-700">Cheikh Ahmada Tijani</h2>
      ...
      <section>
        <h2 className="text-3xl font-bold mb-6 text-green-700">Cheikh Ibrahim Niass</h2>
        <div className="bg-white bg-opacity-10 backdrop-filter backdrop-blur-lg shadow-lg rounded-lg p-8 flex flex-col md:flex-row items-center">
